...
var MenuLayer = cc.Layer.extend({
	...
	init: function() {
		...
		if (typeof Game.score === "undefined") {
			logoText = Game.getLocalizedString("title");
			Game.playEffect("Intro.mp3");
		} else if (Game.lives === 0) {
			logoText = Game.getLocalizedString("lose");
			Game.playEffect("Lose.mp3");
		} else {
			logoText = Game.getLocalizedString("win");
			Game.playEffect("Win.mp3");
		}
